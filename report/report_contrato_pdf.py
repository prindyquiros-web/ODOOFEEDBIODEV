...
from babel.dates import format_date   # 👈 para fechas multi-idioma

_logger = logging.getLogger(__name__)

class ReportContratoPDF(models.AbstractModel):
    _name = 'report.feedbio_provision_custom.report_contrato_pdf_template'
    _description = _('Reporte Contrato PDF')

    def _get_report_values(self, docids, data=None):
        docs = self.env['x.contrato'].browse(docids)
